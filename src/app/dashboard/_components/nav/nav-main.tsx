...
const menus: Menu[] = [
  ...
  {
    group: [
      { href: '/dashboard/user/member', icon: User, name: '成员' },
      { href: '/dashboard/user/visitor', icon: UserRoundSearch, name: '访客' },
      { href: '/dashboard/user/friend-link', icon: Users, name: '友链' }
    ],
    label: 'User'
  },
  {
