import { POST } from '@/app/api/dashboard/users/friend-links/route'
import { ModalCore, ModalCoreProps, ModalCoreRef } from '@/components/modal/modal-core'
...
export const ModalForm = ({ component: Component, value, onSubmit }: ModalFormProps) => {
