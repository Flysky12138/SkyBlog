...
export const Code = ({ children, className, ...props }: React.ComponentProps<'code'>) => {
  // pre > code
  ...
  return (
    <code
      className={cn(['rounded bg-slate-200/50 px-1.5 py-1 dark:bg-slate-600/50', 'before:content-none after:content-none'], className)}
      {...props}
    >
      {children}
    </code>
